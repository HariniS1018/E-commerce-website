...
$query2 = mysqli_query($conn," select *from security as user where user.User_Id in (select userid from customer_reviews as cr where cr.pid=$pid);");
$count = 0;
if(mysqli_num_rows($query) == 0 ){
    echo "<div style='align-items:center'><div style='margin:100px 100px 100px 500px;'><h2>No reviews on this item</h2></div>
                ...
                <a href='view_products.php' class='btn btn-warning'>Go back</a>
            </div></div>";
}
else{
